...
//  mvvm_frame
//
//  Created by 和马乐 on 17/2/16.
//  Copyright © 2017年 mvvm. All rights reserved.
//

#import "SDTabBarController.h"

@interface SDTabBarController () <UIScrollViewDelegate>
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    NSLog(@"%@",_backingViewControllers);
    [_backingViewControllers enumerateObjectsUsingBlock:^(__kindof UIViewController * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
